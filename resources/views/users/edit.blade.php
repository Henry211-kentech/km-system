...
<div class="mb-8">
    ...
    <h1 class="text-3xl sm:text-4xl font-bold text-slate-800 flex items-center gap-2">
        <i class="fas fa-user-edit text-blue-600"></i> Edit User
    </h1>
    <p class="text-slate-600 mt-2">Update user information</p>
</div>
...
<div class="bg-white rounded-xl shadow-md border border-slate-100 overflow-hidden max-w-2xl">
    ...
    <form action="{{ route('users.update', $user) }}" method="POST" class="p-6 sm:p-8">
        ...
        <div class="mb-6">
            <label class="block text-sm font-semibold text-slate-700 mb-2 flex items-center gap-2">
                <i class="fas fa-lock text-blue-500"></i> New Password
                <span class="text-slate-500 text-xs">(leave blank to keep current)</span>
            </label>
            <input
                type="password"
                name="password"
        ...
        <div class="mb-8">
            <label class="block text-sm font-semibold text-slate-700 mb-2 flex items-center gap-2">
                <i class="fas fa-lock text-blue-500"></i> Confirm New Password
            </label>
            <input
                type="password"
